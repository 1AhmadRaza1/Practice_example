...
<script type="text/javascript" src="javascript/add_purchase_product.js"></script>
</head>
<body id="b1">
<br>
<br>
<br>
	...
	<input type="hidden" id="last_purchase_item_master_id" name="last_purchase_item_master_id" />
	<table align="center">
		<thead>
				<tr>
